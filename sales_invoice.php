...
$invoice_no = $max;
 ...
 //splitting   
    ...
    $sql = "INSERT INTO sales_invoice_temp (invoice_no, item_code, item_name, dated, purchaserate,salerate, quantity, amount,acount_code,name,contact,address,headname,userid)
...
<input type="submit" name="addnewsale" class="btn btn-info" value="Add"><br>
